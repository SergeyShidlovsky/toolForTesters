...
@echo STAGE2.DATA DELETION AND SERVICE RESTARTING WITH ENABLED DEBUG LOGGING
...
@echo CUE and Clink ProgramData folders will be cleared
@echo off
CD C:\ProgramData\
SET mypath=%~dp0
@echo on
...
@echo Enabling Service Messaging in  Debug logging of Integration service
mkdir "C:\ProgramData\Corsair\CUE\Service logs"

echo { > D:\DebugLogging
echo "DebugLoggingServiceInteraction": { >> D:\DebugLogging
echo   "$type": "CorsairLink4.DeviceCache.Items.Settings.DebugLogging.DebugLoggingServiceInteractionSettings, CorsairLink4.DeviceCache", >> D:\DebugLogging
echo   "ingoing-messages": true, >> D:\DebugLogging
echo   "outgoing-messages": true, >> D:\DebugLogging
echo   "short-version": false, >> D:\DebugLogging
echo   "format-output": true >> D:\DebugLogging
echo }, >> D:\DebugLogging
echo "DebugLogging": { >>D:\DebugLogging
echo   "$type": "CorsairLink4.DeviceCache.Items.Settings.DebugLogging.IntegrationDebugLoggingSettings, CorsairLink4.DeviceCache", >> D:\DebugLogging
echo   "enabled": true, >> D:\DebugLogging
echo   "log-folder": "C:\\ProgramData\\Corsair\\CUE\\Service logs" >> D:\DebugLogging
echo } >> D:\DebugLogging
echo } >> D:\DebugLogging

copy  "D:\DebugLogging" "C:\ProgramData\Corsair\CUE\Settings" > nul
del "D:\DebugLogging"
